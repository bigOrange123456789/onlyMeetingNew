...
InstancedGroupTest.prototype={
        ...
        test6_2:function (contextType){
                ...
                loader.load("myModel/avatar/Female.glb", (glb) => {
                        ...
                        console.log(
                            myInstanceGroup.decode(data[0],data[data.length/2]),
                            myInstanceGroup.decode(data[1],data[1+data.length/2]),
                            myInstanceGroup.decode(data[10],data[10+data.length/2]),
                            myInstanceGroup.decode(data[100],data[100+data.length/2])
                        );
                        //一帧的举起动作数据
                        var data0=[
                                5.976657588905034,
                        ...
                        var data1=[],data2=[];
                        console.log(myInstanceGroup.decode(177,162));
                        ...
                        //data1=[];data2=[];
                        //data=[11,12,14,22,23,24]
                        //data1=[1,2,3];data2=[1,2,3];
                        //data0=[1,2,3,11,12,13];
                        //data1=[4,5];
                        ...
                        console.log(data[973]);
                        console.log(
                            //data[10],data[100],data[500],
                            data[974],data[975]
                            );
                        link.click();
                        function compose(x,y,z,w,sx,sy,sz,px,py,pz ) {//quaternion scale,position
