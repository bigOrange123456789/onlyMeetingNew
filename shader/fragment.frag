...
vec4 TextureController_computeMyTexture(){
    ...
    if(u>0.5)u=1.0-u;
    u=u*2.0;
    oTextureController.widthOneImg=1.0/TEXT_NUM;
    oTextureController.imgStart=texType/TEXT_NUM;
    oTextureController.uPixel=oTextureController.imgStart+u/TEXT_NUM;
