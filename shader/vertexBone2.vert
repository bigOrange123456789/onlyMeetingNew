...
void main(){
    ...
    float test=0.;
    //if(round(index)==1845.)test=0.5;
    gl_Position = projectionMatrix * modelViewMatrix * matrix2 * matrix1  * vec4(position.x*w+test,position.y,position.z*w, 1.0);
